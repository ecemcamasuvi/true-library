...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="transform: translateY(205px); margin-left: 640px;" id="divTur" runat="server" >
        <table>
            <tr>
                <td>
                    <asp:Button runat="server" Text="Roman" ID="roman" OnClick="Tur_Click" class="btnTur" /></td>
                <td>
                    <asp:Button runat="server" Text="Şiir" ID="siir" OnClick="Tur_Click" class="btnTur" /></td>
                <td>
                    <asp:Button runat="server" Text="Bilim" ID="bilim" OnClick="Tur_Click" class="btnTur" /></td>
                <td>
                    <asp:Button runat="server" Text="Çocuk Kitabı" ID="cocukKitabi" OnClick="Tur_Click" class="btnTur" /></td>
                <td>
                    <asp:Button runat="server" Text="Çizgi Roman" ID="cizgiRoman" OnClick="Tur_Click" class="btnTur" /></td>
                <td>
                    <asp:Button runat="server" Text="Tarih" ID="tarih" OnClick="Tur_Click" class="btnTur" /></td>
                <td>
                    <asp:Button runat="server" Text="Felsefe" ID="felsefe" OnClick="Tur_Click" class="btnTur" /></td>
            </tr>
        </table>
    </div>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="req1" runat="server" ControlToValidate="txtKitapAd" ErrorMessage="*" ForeColor="#ff3300" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="req2" runat="server" ControlToValidate="txtYazar" ErrorMessage="*" ForeColor="#ff3300" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="req3" runat="server" ControlToValidate="txtYayinci" ErrorMessage="*" ForeColor="#ff3300" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="req4" runat="server" ControlToValidate="txtTur" ErrorMessage="*" ForeColor="#ff3300" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="req5" runat="server" ControlToValidate="txtSayfa" ErrorMessage="*" ForeColor="#ff3300" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="req6" runat="server" ControlToValidate="txtTarih" ErrorMessage="*" ForeColor="#ff3300" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="req7" runat="server" ControlToValidate="txtTarih" ErrorMessage="*" ForeColor="#ff3300" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
