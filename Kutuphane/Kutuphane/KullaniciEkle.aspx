...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="add" runat="server" class="table1">
        <table>
            ...
            <tr>
                <td>
                    <asp:Label Text="Kullanıcı Adı : " runat="server" class="label1" />
                </td>
                <td>
                    <asp:TextBox ID="txtuserName" runat="server" class="text1" />
                     <asp:RequiredFieldValidator ID="req5" runat="server" ControlToValidate="txtUserName" ErrorMessage="*" ForeColor="#ff3300"/>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label Text="Şifresi : " runat="server" class="label1" />
                </td>
                <td>
                    <asp:TextBox ID="txtParola" runat="server" class="text1" TextMode="Password" />
                     <asp:RequiredFieldValidator ID="req6" runat="server" ControlToValidate="txtParola" ErrorMessage="*" ForeColor="#ff3300" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
