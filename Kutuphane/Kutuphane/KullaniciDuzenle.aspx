        ...
        <asp:GridView ID="gridKullanici" runat="server" class="grid" AutoGenerateColumns="false">
            ...
            <Columns>
                <asp:TemplateField HeaderText="Kullanıcı ID">
                    <ItemTemplate>
                        <asp:HyperLink runat="server" class="butonKitap" Text='<%#Eval("ID") %>' NavigateUrl='<%#Eval("ID","~/KullaniciDuzenle.aspx?kullaniciID={0}") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Kullanıcı Adı">
                    <ItemTemplate>
                        <asp:HyperLink runat="server" class="butonKitap" Text='<%#Eval("KullaniciAd") %>' NavigateUrl='<%#Eval("ID","~/KullaniciDuzenle.aspx?kullaniciID={0}") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
