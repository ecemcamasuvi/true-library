...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> <!--Kitap türü seçmeyi sağlayan butonlar-->
    <div style="transform:translateY(15px); margin-left:680px;" id="divTur" runat="server" visible="false">
        <table>
            <tr>
                <td><asp:Button runat="server" Text="Roman" ID="roman" OnClick="Tur_Click" class="btnTur"/></td>
                <td><asp:Button runat="server" Text="Şiir" ID="siir" OnClick="Tur_Click" class="btnTur" /></td>
                <td><asp:Button runat="server" Text="Bilim" ID="bilim" OnClick="Tur_Click" class="btnTur" /></td>
                <td><asp:Button runat="server" Text="Çocuk Kitabı" ID="cocukKitabi" OnClick="Tur_Click" class="btnTur" /></td>
                <td><asp:Button runat="server" Text="Çizgi Roman" ID="cizgiRoman" OnClick="Tur_Click" class="btnTur" /></td>
                <td><asp:Button runat="server" Text="Tarih" ID="tarih" OnClick="Tur_Click" class="btnTur" /></td>
                <td><asp:Button runat="server" Text="Felsefe" ID="felsefe" OnClick="Tur_Click" class="btnTur" /></td>
            </tr>
        </table>
    </div>
                    ...
                    <ItemTemplate>
                        ...
                        <div class="overlay">
                            <table class="tablo">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label runat="server" Text="Stok : " class="label1" />
                                    </td>
                                    <td>
