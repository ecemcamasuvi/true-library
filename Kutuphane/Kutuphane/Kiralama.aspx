...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="search" runat="server" class="search">
        <table class="tableSearch">
            <tr>
                <td>
                    <asp:TextBox type="text" placeholder="Kitabın ya da yazarın adını giriniz.." name="search2" ID="txtsearch" runat="server" />
            ...
            <tr>
                <td colspan="2">
                    <asp:Label Text="Aradığınız Kitap Bulunamadı." runat="server" ID="lblBulunamadi" Visible="false" />
                </td>
            </tr>
        </table>
    </div>
    ...
    <div id="add" runat="server" class="table1" visible="false">
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:Label ID="txtKitapAd" runat="server" class="label1" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="txtYazar" runat="server" class="label1" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="txtYayinci" runat="server" class="label1" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="txtTur" runat="server" class="label1" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="txtSayfa" runat="server" class="label1" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="txtTarih" runat="server" class="label1" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:Label ID="txtAdet" runat="server" class="label1" />
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label Text="Aktif Olma Durumu : " runat="server" class="label1" />
                </td>
                <td>
                    <asp:Label ID="txtAktif" runat="server" class="label1" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                <td colspan="2">
                    <asp:Button Text="Kitabı Kirala" ID="btnKira" runat="server" OnClick="btnKira_Click" type="submit" class="buttonKira" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <asp:Button Text="Kitabı İade Et" ID="btnIade" runat="server" OnClick="btnKira_Click" type="submit" class="buttonKira" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <asp:Button runat="server" class="buttonKira" Text="Yorumları Görüntüle" ID="showComments" OnClick="Yorum_Click" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <asp:Label class="label1" Text="Seçtiğiniz kitap bulunmamaktadır." ID="nobookA" Visible="false" runat="server" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
    ...
    <div class="confirm" id="confirm" runat="server" visible="false">
        <asp:Label Text="Kitaba ait bilgiler başarılı bir şekilde güncellenmiştir." runat="server" class="confirmLabel2" />
    </div>


    <div class="confirm" id="confirmDel" runat="server" visible="false">
        <asp:Label Text="Kitap başarılı bir şekilde silinmiştir." runat="server" class="confirmLabelDel" />
    </div>

    <div class="confirm" id="confirmRent" runat="server" visible="false">
        <asp:Label Text="Kitap kiralama başarılı bir şekilde kaydedilmiştir." runat="server" class="confirmLabelDel" />
    </div>
                    ...
                    <ItemTemplate>
                        ...
                        <div class="overlay">
                            <table class="tablo">
                                <tr>
                                    <td>
                                        <asp:Label runat="server" Text="Kitap Adı : " class="label1" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label runat="server" Text="Yazar : " class="label1" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label runat="server" Text="Yayınevi: " class="label1" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label runat="server" Text="Sayfa Sayısı : " class="label1" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label runat="server" Text="Tür : " class="label1" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label runat="server" Text="Basım Tarihi : " class="label1" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label runat="server" Text="Kitap Adeti : " class="label1" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label runat="server" Text="Aktif Olma Durumu : " class="label1" />
                                    </td>
                                    <td>
    ...
    <div class="divKira" id="kira" visible="false" runat="server">
        ...
        <table class="tableKira">
            <tr>
                ...
                <td>
                    <asp:Label runat="server" class="label1" ID="lblkitapAd" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label runat="server" Text="Kullanıcı Adı : " class="label1" />
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="errorMessage" runat="server" class="labelError" Text="Lütfen günü doğru seçiniz" Visible="false" />
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="errorMessageK" runat="server" class="labelError" Text="Seçtiğiniz kullanıcı bulunamadı." Visible="false" />
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="errorKullanici" runat="server" class="labelError" Text="Kitabı iade etmeden tekrar kiralayamazsınız." Visible="false" style="transform:translate(5px,-10px)"/>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="confirm" id="iadeInfo" runat="server" visible="false">
        <table class="table1" style="transform: translate(-40px,10px)">
            <tr>
                <td><asp:Label CssClass="label1" Text="Adı Soyadı : " runat="server" /></td>
                <td>
                    <asp:Label CssClass="label1" id="fullNameIade" runat="server" />
                </td>
            </tr>
            <tr>
                <td><asp:Label CssClass="label1" Text="Kullanıcı Adı : " runat="server" /></td>
                <td>
                    <asp:Label CssClass="label1" id="usernameIade" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label CssClass="label1" Text="Kullanıcı ID : " runat="server" /></td>
                <td>
            ...
            <tr>
                <td colspan="2">
                    <asp:Button CssClass="butonKitap" runat="server" OnClick="iadeOnay_Click" Text="İade Et" />
                </td>
            </tr>
        </table>
    </div>
