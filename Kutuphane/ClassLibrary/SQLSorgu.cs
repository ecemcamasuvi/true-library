...
namespace ClassLibrary
{
    public class SQLSorgu
    {
        ...
        {
            string sorgu = "INSERT INTO tblKitaplar (KitapAd,Yazar,Yayinci,SayfaSayisi,Tarih,AktifPasif,Fotograf,Tur,BasimTarih,Puan,Puanlayan,KitapSayisi) VALUES ('" + ad + "','" + yazar + "','" + yayinci + "','" + sayfaSayisi + "','" + System.DateTime.Now.ToLongTimeString() + "',1,'" + fotograf + "','" + tur + "','" + basimTarihi + "',0,0,'"+kitapSayisi+"')";
            return sorgu;
        }
